...
export default function VendorDashboard() {
  ...
  const checkVendorAccess = async () => {
    ...
    // Check vendor access and handle admin users
    ...
    // If user is an admin, redirect to admin dashboard immediately
    ...
    // If no application found, could be admin user - check by email and user_id
    if (!userApplication) {
      ...
      try {
        ...
        // Also check by user_id in case email doesn't match
